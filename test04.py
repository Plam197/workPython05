#รับข้อมูลจำนวนเต็ม 5 จำนวนจากผู้ใช้ และคำนวรหาผลรวม และค่าเฉลี่ยของข้อมูลที่รับเข้ามาเป็นเท่าใด แล้วแสดงผลทางหน้าจอ
#ขอ 4 ฟังก์ขั้น ดั้งนั้นหาให้ได้ 4 feature

#===============================
# Program Average 5 Numder
#=====================================
...
#1รับค่า number 2.คำนวณผลรวม ของnumber 3.คำนวณหาค่าเฉลี่ยของnumber 4.แสดงผลทางหน้าจอ
def inputData( ) :
...
print('================================')
print('             Progran Average 5 Number           ')
print('================================')
